...
class ACL
{
    ...
    {
        $ids = $this->_db->query(
                "select permiso from tblpermisos_role " .
    ...
    public function getPermisoNombre($permisoID)
    {
        ...
        $key = $this->_db->query(
                "select `permiso` from tblpermiso " .
                "where id_permiso = {$permisoID}"
                );
    ...
    public function getPermisosUsuario()
    {
        ...
        if(count($ids)){
            $permisos = $this->_db->query(
                    "select * from tblpermisos_usuario " .
