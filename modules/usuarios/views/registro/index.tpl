<div class="container" style="padding-left: 49px;max-width: 64%;">
    <div class="row">
        <form name="form1" method="post" action="" class="form">
            ...
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--4-col">
                    <label>Usuario: </label>
                    <input style="width: 90%;" class="input-large" type="text" name="usuario" value="{$datos.usuario|default:""}"
