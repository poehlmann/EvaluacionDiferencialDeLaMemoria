...
class indexModel extends Model
{
    ...
    public function getUsuarios()
    {
        $usuarios = $this->_db->query(
                "select u.*,r.role from tblusuario u, tblrol r ".
    ...
    {
         $usuarios = $this->_db->query(
                "select u.usuario,r.role from tblusuario u, tblrol r ".
    ...
    {
        $this->_db->query(
                "delete from tblpermisos_usuario where ".
    ...
    {
        $this->_db->query(
                "replace into tblpermisos_usuario set ".
