<?php /* Smarty version Smarty-3.1.8, created on 2015-07-13 23:27:36
...
views/encuesta/img/audio.png">Escuche la orden</button>
                <button class="botonesdemo" id="button1" onclick="hover2.playclip();this.disabled= true;document.getElementById('button50').style.display = 'block';this.style.display = 'none' " style="display:none;"><input type="image" onclick='return false;' src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
...
views/encuesta/img/audio.png">Escuche la orden</button>
                <button  id="accion1" class="botonesdemo" onclick="hover41.playclip();document.getElementById('accion2').style.display = 'block'; this.style.display = 'none';" style="display:none"><input type="image" onclick='return false;' src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
views/encuesta/img/audio.png" >Acci&oacute;n 1</button>
                <button  id="accion2" class="botonesdemo" onclick="hover42.playclip();document.getElementById('accion3').style.display = 'block'; this.style.display = 'none';" style="display:none"><input type="image" onclick='return false;' src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
views/encuesta/img/audio.png" >Acci&oacute;n 2</button>
                <button  id="accion3" class="botonesdemo" onclick="hover43.playclip(); this.style.display = 'none';" style="display:none"><input type="image" onclick='return false;' src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
