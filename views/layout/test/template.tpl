...
<html lang="es">
    ...
    <body style="height:110px; background: url('http://localhost:8080/mvc/views/layout/test/img/fondo.jpg') ">
      {if isset($widgets.top)}
        ...
        <div style="background: #34612B; height: 110px; margin-bottom: 20px; width: 100%;">
            <div class="container">
        ...
        <div class="navbar navbar-fixed-bottom">
            <div class="navbar-inner">
                <div class="container">
                    <div style="margin-top: 10px; text-align: center;">Copyright&copy; 2015 <a href="UPSA" target="_blank">UPSA</a></div>
                </div>
            </div>
        </div>
